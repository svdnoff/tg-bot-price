...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        "👋 Привет! Я бот магазина *ДругоеМесто* — помогу узнать актуальные цены на технику.\n\n"
        "Просто напишите название устройства, а я покажу цены по всем доступным версиям и объёмам памяти.\n\n"
        "✏️ *Примеры запросов:*\n"
        "• Айфон 16 про макс\n"
        "• iPhone 15\n"
        "• Samsung S25 Ultra\n"
        "• С26 ультра\n"
        "• Самсунг А56\n\n"
        "💬 *Хотите заказать или уточнить цвет/наличие?*\n"
        "Напишите нам в лс — @DrygoeMesto23, всё решим 🤝\n\n"
        "⌚🎮 Также привозим Apple Watch, PS5 и другую технику — спрашивайте!"
    )
